...
class SettingsStyleController extends State<SettingsStyle> {
  ...
  static final List<Color?> customColors = [
    null,
    AppConfig.chatColor,
    Color(0xFF3E478E), // Colors.indigo,
    Color(0xFF62E6FF), // Colors.blue,
    Color(0xFF94eeff), // Colors.blueAccent,
    Color(0xFFa8ffff), // Colors.teal,
    Color(0xFFBAFFFF), // Colors.tealAccent,
    Color(0xFF7DFFB8), // Colors.green,
    Color(0xFFA7FFCE), // Colors.greenAccent,
    Color(0xFFFFEDCC), // Colors.yellow,
    Color(0xFFfffddc), // Colors.yellowAccent,
    Color(0xFFFFD890), // Colors.orange,
    Color(0xFFFFD890), // Colors.orangeAccent,
    Color(0xFFFF8F6C), // Colors.red,
    Color(0xFFFF8F6C), // Colors.redAccent,
