...
abstract class AppConfig {
  ...
  static const Color primaryColor = Color(0xFFD2BBFA);
  static const Color primaryColorLight = Color(0xFFD2BBFA);
  static const Color secondaryColor = Color(0xFFD2BBFA);
